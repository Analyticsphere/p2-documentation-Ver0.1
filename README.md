...
- Houses three key datasets:
  ...
  - **ControlledTier**: Controlled tier filter
...
| `/createControlledTier` | POST | Filters Clean Connect tables for controlled tiers |
...
### 4. Filter Tables for Controlled Tier
